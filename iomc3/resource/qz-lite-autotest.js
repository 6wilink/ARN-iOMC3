...
(function($) {
	$.AutoTest = {
		...
		Signin : function(timeoutInMs, timeoutStepInMs) {
			console.log("*test Signin> start =", timeoutInMs, ', step =',
					timeoutStepInMs);
		...
		Nav : function(timeoutInMs, timeoutStepInMs) {
			console.log("*test MainProcess> start =", timeoutInMs, ', step =',
					timeoutStepInMs);
			var toInMs = timeoutInMs;
			setTimeout(function() {
		...
		Devices : function(timeoutInMs, timeoutStepInMs) {
			console.log("*test Devices> start =", timeoutInMs, ', step =',
					timeoutStepInMs);
			// test search
			var toInMs = timeoutInMs;
		...
		Maps : function(timeoutInMs, timeoutStepInMs) {
			console.log("*test Maps> start =", timeoutInMs, ', step =',
					timeoutStepInMs);
			var toInMs = timeoutInMs;
		...
		Options : function(timeoutInMs, timeoutStepInMs) {
			console.log("*test Options> start =", timeoutInMs, ', step =',
					timeoutStepInMs);
			var toInMs = timeoutInMs;
			setTimeout(function() {
				console.log('*test> try options');
